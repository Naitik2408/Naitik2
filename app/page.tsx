  ...
  return (
    <main>
      ...
      <section className="bg-[#f4f4f4]">
        <div className="px-8 py-16 max-w-7xl mx-auto flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="flex-1 relative">
            ...
            <div className="absolute -bottom-8 left-0 right-0 flex px-8 gap-4">
      ...
      <section className="px-8 py-24 max-w-7xl mx-auto mt-16">
        ...
        <div className="flex justify-between items-center mt-24 px-12 border-t pt-16">
          <div className="text-center">
            <div className="text-5xl font-bold text-gray-800">20<span className="text-4xl text-gray-500">K+</span></div>
            <div className="text-gray-400 text-sm mt-2 font-medium">Lines of Code</div>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-gray-800">100<span className="text-4xl text-gray-500">%</span></div>
            <div className="text-gray-400 text-sm mt-2 font-medium">Project Completion</div>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-gray-800">04<span className="text-4xl text-gray-500">+</span></div>
            <div className="text-gray-400 text-sm mt-2 font-medium">Years Learning</div>
          </div>
        </div>
      </section>
      ...
      <section id="projects" className="bg-[#165a4a] text-white py-24 px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Card 1 */}
            <div className="bg-[#fafafa] text-black flex h-[400px]">
              <div className="w-1/2 bg-gray-300">
                <img src="/project/project1.webp" alt="TipTop" className="w-full h-full object-cover" />
              </div>
              <div className="w-1/2 p-8 flex flex-col justify-between">
                <div>
                  <div className="text-2xl font-bold text-[#165a4a] mb-6">01</div>
                  <h3 className="text-xl font-bold mb-4">TipTop</h3>
                  <p className="text-gray-500 text-sm">A comprehensive productivity platform designed to help teams organize workflows, track tasks efficiently, and collaborate seamlessly in real-time to achieve their goals.</p>
                </div>
                <div className="flex gap-4 items-center mt-4">
                  <Link href="/projects/tiptop" className="text-[#165a4a] font-medium border-b border-[#165a4a] pb-1">Learn more</Link>
                  <a href="https://thetiptop.in" target="_blank" rel="noopener noreferrer" className="text-gray-500 font-medium text-sm hover:text-black">Live Link ↗</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#fafafa] text-black flex h-[400px]">
              ...
              <div className="w-1/2 p-8 flex flex-col justify-between">
                <div>
                  <div className="text-2xl font-bold text-[#165a4a] mb-6">02</div>
                  <h3 className="text-xl font-bold mb-4">LiftMyGrade</h3>
                  <p className="text-gray-500 text-sm">An educational platform focused on student success, providing personalized learning paths, comprehensive grade tracking, and interactive resources to boost performance.</p>
                </div>
                <div className="flex gap-4 items-center mt-4">
                  <Link href="/projects/liftmygrade" className="text-[#165a4a] font-medium border-b border-[#165a4a] pb-1">Learn more</Link>
                  <a href="https://liftmygrade.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 font-medium text-sm hover:text-black">Live Link ↗</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="px-8 py-24 max-w-7xl mx-auto flex flex-col md:flex-row gap-16 relative items-start">
        ...
        <div className="flex-1 relative pb-24 space-y-12">
          <div className="md:sticky md:top-32 bg-white border border-gray-100 rounded-2xl p-8 shadow-sm origin-top">
          ...
          <div className="md:sticky md:top-[140px] bg-white border border-gray-100 rounded-2xl p-8 shadow-md origin-top">
          ...
          <div className="md:sticky md:top-[152px] bg-white border border-gray-100 rounded-2xl p-8 shadow-lg origin-top">
      ...
      <section className="bg-[#f8f8f8]">
        <div className="px-8 py-24 max-w-7xl mx-auto flex flex-col md:flex-row gap-16">
          <div className="w-1/3 space-y-6 relative border-r-2 border-gray-200 pr-8">
